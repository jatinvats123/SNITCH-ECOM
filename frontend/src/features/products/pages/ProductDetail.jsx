...
const ProductDetail = () => {
  ...
  const currentImage =
    images[selectedImage]?.url || "https://placehold.co/800x1000/f7f7f7/cccccc/webp?text=";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-16 xl:gap-28 pb-32">
          ...
          <div className="flex flex-col lg:sticky lg:top-24 lg:self-start">
                  ...
                  <div className="flex flex-wrap gap-4">
                    {product.variants.map((variant, idx) => {
                      ...
                      const variantImage =
                        ...
                        "https://placehold.co/100x100/f7f7f7/cccccc";
            ...
            <div className="flex flex-col gap-4 mb-16">
              ...
              <button
                onClick={() =>
                  handleAddToCart(product._id, selectedVariant?.variantId || selectedVariant?._id)
                }
                id="add-to-cart-btn"
                type="button"
